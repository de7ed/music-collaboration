...
function TagAddPopover({
  ...
  const emptyMessage = () => {
    if (trimmed) return existingIds.size > 0 ? "No other tags match" : "No tags match — press Add to create"
    if (existingIds.size > 0 && availableTags.every((t) => existingIds.has(t.id))) return "All tags already applied"
