...
import { Plus, FileText, MessageSquare, MoreHorizontal, X, Globe, Lock, Share2, Trash2, Tag as TagIcon } from "lucide-react"
...
export function LyricSheetList({
  ...
  // Merged available tags: server-fetched + any newly created inline
  ...
  const updateSheet = useCallback((id: string, patch: Partial<Sheet>) => {
    ...
    // If new tags were added, merge into localTags
    if (patch.tags) {
